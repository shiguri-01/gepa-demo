...
### 【評価基準】 (Scoring Rubric)
*   **1.0: 思考プロセス・最終的な答え、共に完璧**
    *   思考プロセスは完全に論理的で矛盾がなく、かつ最終的な答えも完全に正確である。
*   **0.8: 思考プロセスは論理的だが、最終的な答えに軽微な誤りがある**
    *   思考プロセスは論理的に正しいものの、計算ミス、ごくわずかな事実誤認、転記ミスなど、プロセスの本筋とは関係のない部分で最終的な答えに軽微な誤りが生じている。
*   **0.6: 思考プロセスに軽微な欠陥があるが、最終的な答えは概ね正しい**
    *   思考プロセスに一部、論理の飛躍や小さな見落としが含まれるが、それが最終的な答えの致命的な誤りには至っておらず、概ね正しい結論が得られている。
*   **0.4: 思考プロセスと最終的な答えの両方に、無視できない誤りが含まれる**
    *   思考プロセスに複数の誤りや矛盾点があり、その結果として最終的な答えにも明確な誤りが含まれている。
*   **0.2: 思考プロセスに重大な欠陥があり、最終的な答えも大幅に不正確**
    *   思考プロセスの根幹に重大な論理的誤りや勘違いがあり、その結果として最終的な答えが的外れなものになっている。
*   **0.0: 評価の前提条件を満たしていない**
    *   以下のいずれかに該当する場合: 思考プロセスが全く示されていない。思考プロセスが論理的に完全に破綻している。質問の意図を全く理解しておらず、回答として成立していない。
`.trim();
